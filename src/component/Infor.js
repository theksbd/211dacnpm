        ...
        <div className="container" >
                ...
                <div style={{border: '2px solid #C4C4C4', borderRadius: '12px', textAlign:'center'}}>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <td>{detailData.screen} inches</td>
                            </tr>
                            <tr>
                            <th scope="row">Chipset</th>
                            <td>{detailData.chip}</td>
                            </tr>
                            <tr>
                            <th scope="row">Dung lượng RAM</th>
                            <td>{detailData.ram} GB</td>
                            </tr>
                            <tr>
                            <th scope="row">Bộ nhớ trong</th>
                            <td>{detailData.rom1} GB</td>
                            </tr>
                            <tr>
                            <th scope="row">Pin</th>
                            <td>{detailData.pin}</td>
                            </tr>
                            <tr>
            ...
            <div class="col-md-7 col-sm-12" >
                ...
                <div class="d-flex">
                    ...
                    <div class="col-md-7 col-sm-7" >
                        <h4 style={{lineHeight:"50px"}}>{detailData.newPrice} * 1 = {detailData.newPrice}</h4>
                    </div>
                </div>
                <div class="d-flex">
                    <div class="col-md-5 col-sm-5">
                    ...
                    <div class="col-md-7 col-sm-7" >
                        <h4 style={{lineHeight:"50px"}}>{detailData.newPrice}</h4>
                    </div>
                </div>
                <div style={{textAlign:"center"}}>
                <button type="button" style={{border: '0.5px solid #C4C4C4', borderRadius: '12px',width: "100px", marginLeft:"20px"}} class="btn btn-outline-secondary">{detailData.rom1} <br/> {detailData.newPrice} Đ</button>
                <button type="button" style={{border: '0.5px solid #C4C4C4', borderRadius: '12px',width: "100px", marginLeft:"20px"}} class="btn btn-outline-secondary">{detailData.rom2} <br/> {detailData.newPrice} Đ</button>
                <button type="button" style={{border: '0.5px solid #C4C4C4', borderRadius: '12px',width: "100px", marginLeft:"20px"}} class="btn btn-outline-secondary">{detailData.rom3} <br/> {detailData.newPrice} Đ</button>
                <button type="button" style={{border: '0.5px solid #C4C4C4', borderRadius: '12px',width: "100px", marginLeft:"20px"}} class="btn btn-outline-secondary">{detailData.rom4} <br/> {detailData.newPrice} Đ</button>
                </div>
