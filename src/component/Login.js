...
export default function Login() {
    ...
    return (
        <div className=''>
            ...
            <div className="">
                <div className="container-md" style={{ width: "350px", paddingTop: "100px" }} >
                    <form>
                        ...
                        {/* {userAccountData.} */}
                        <div className="form-check mx-2 mt-3 mb-3">
                            <input className="form-check-input" type="checkbox" value="" id="flexCheckDefault" />
                            <label className="form-check-label" for="flexCheckDefault">
                                Remember me
                            </label>
                        </div>
                        <a className="float-start" href='#'> Quên mật khẩu </a>
                        <button className="w-50 btn btn-lg btn-success float-end" type="submit" onClick={handleSubmit}>Log in</button>
                        <ToastContainer />
                    </form>
                </div>
            </div>
