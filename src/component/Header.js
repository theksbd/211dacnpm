...
export default function Header() {
    return <nav className="navbar navbar-expand-lg navbar-light bg-light shadow-sm fixed-top">
        <div className="container-fluid">
            <a className="navbar-brand " href="#" style={{ fontFamily: "Roboto", fontSize: "36px" }}>Logo</a>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                    <li className="nav-item">
                        <a className="nav-link active text-danger" aria-current="page" href="#">Giới Thiệu</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link active" href="#">Tuyển Dụng</a>
                    </li>
                    <li className="nav-item">
                ...
                <button className="btn btn-outline-primary me-3" type="submit">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-people-fill mb-1 me-1" viewBox="0 0 16 16">
